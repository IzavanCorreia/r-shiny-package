...
Para aprender a criar um pacote em R é indicado assistir ao tutorial abaixo, sobre como construir pacotes em R e subir para o GitHub:

<https://www.youtube.com/watch?v=w7wmuxGvJNw&feature=youtu.be>

### O que é shiny?

O Shiny se trata de um sistema para desenvolvimento de aplicações web usando o R, um pacote do R (shiny) e um servidor web (shiny server).
